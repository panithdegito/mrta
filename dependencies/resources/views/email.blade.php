...
<head>
    ...
    <style type="text/css">
        ...
        .emailButton{color: #c5a47e;  background-color: #ffffff;  border-color: #c5a47e; border-collapse:separate;}
        .buttonContent{color: #c5a47e;
            background-color: #ffffff;
            border-color: #c5a47e; font-family:Helvetica; font-size:18px; font-weight:bold; line-height:100%; padding:15px; text-align:center;}
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                                                        <tr>
                                                            <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                                                <a style="color: #c5a47e;background-color: #ffffff;;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="#" target="_blank">Confirmation</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->

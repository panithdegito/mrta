    ...
    <div class="bg-orange">
        <div class="container">
            <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item active">แก้ไขสถานี {{$station->translateDefault()->name}}</li>
            </ol>
        </div>
    </div>
    <!-- START JUMBOTRON -->
    <div class="jumbotron">
        <div class=" container p-l-0 p-r-0   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner heading-padding">
                <!-- START BREADCRUMB -->
                <h1>แก้ไขสถานี {{$station->translateDefault()->name}}
                </h1>
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form method="POST" action="{{route('stations.update', $station->id)}}" accept-charset="UTF-8" id="form-work" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate">
                            ...
                            <div class="form-group row{{ $errors->has('code') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control error" id="code" placeholder="OR01" name="code"  value="{{old('code', $station->code)}}" required="" aria-required="true" aria-invalid="true" maxlength="4">
                                </div>
                            </div>
                                            ...
                                            @foreach($languages as $language)
                                                @if($language->default == 1)
                                                    <div class="tab-pane fade active show" id="{{$language->abbreviation}}" aria-expanded="true">
                                                        <input type="text" class="form-control error" id="name{{$language->abbreviation}}" placeholder="" name="name{{$language->abbreviation}}"  value="{{old('name'.$language->abbreviation, $station->translate($language->abbreviation)->name)}}" required="" aria-required="true" aria-invalid="true">
                            ...
                            <div class="form-group row{{ $errors->has('progress') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group date col-md-12 p-l-0">
                                        <input type="text" class="form-control allownumericwithdecimal" name="progress" placeholder="00.00" value="{{old('progress', $station->progress)}}"><span class="input-group-addon">%</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row{{ $errors->has('kilometer') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control error allownumericwithdecimal" id="kilometer" placeholder="00.00" name="kilometer"  value="{{old('kilometer', $station->kilometer_marker)}}" required="" aria-required="true" aria-invalid="true">
                                </div>
                            </div>
                            ...
                            <div class="form-group row{{ $errors->has('status') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    @foreach($status as $status)
                                        @if(old('status', $station->status_id) == $status->id)

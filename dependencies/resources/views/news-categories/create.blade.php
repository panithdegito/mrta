    ...
    <div class="bg-orange">
        <div class="container">
            <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item active">เพิ่มประเภทข่าวสาร</li>
            </ol>
        </div>
    </div>
    <!-- START JUMBOTRON -->
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form method="POST" action="{{route('news-categories.store')}}" accept-charset="UTF-8" id="form-work" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate">

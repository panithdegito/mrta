        ...
        <div class="container">
            <div class="menu-bar header-sm-height" data-pages-init='horizontal-menu' data-hide-extra-li="4">
                ...
                <ul>
                    ...
                    <li class="active">
                        <a href="javascript:;">ประเภทข่าวสาร</a>
                    </li>
    ...
    <div class="bg-orange">
        <div class="container">
            <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item active">ประเภทข่าวสาร</li>
            </ol>
        </div>
    </div>
    <!-- START JUMBOTRON -->
            ...
            <div class="inner heading-padding">
                <!-- START BREADCRUMB -->
                        <h1>ประเภทข่าวสาร
                            ...
                            <a href="{{route('news-categories.create')}}" class="btn btn-hotel btn-primary-hotel btn-top-page pull-right"><i class="icon-plus"></i> เพิ่มประเภทข่าวสาร</a>
                        </h1>
            ...
            <div class="card-block">
                ...
                <div class="table-responsive">
                    <div id="basicTable_wrapper" class="dataTables_wrapper no-footer">
                        <form action="{{route('news_category_destroymany')}}" method="post">
                            {{csrf_field()}}
                            <table class="table table-hover dataTable no-footer" id="basicTable" role="grid">
                                ...
                                <tr role="row">
                                    ...
                                    <th style="width: 83%" class="sorting" tabindex="0" aria-controls="basicTable" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending">ชื่อ</th>
                                ...
                                @if(sizeof($news_categories) != 0)
                                    @foreach ($news_categories as $news)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="v-align-middle">
                                                {{ $news->translateDefault()->name }}
                                            </td>


                                            <td class="v-align-middle">
                                                <a href="{{ route('news-categories.edit',$news->id) }}" class="btn btn-hotel btn-edit pull-left" style="margin-right: 3px;"><i class="icon-pencil"></i></a>
                                    ...
                                    @endforeach
                                @else
                                    <tr><td></td><td>ไม่พบประเภทข่าวสารในตอนนี้</td><td></td><td></td></tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center m-t-20">
                                                    <h5>คุณต้องการลบข้อมูลประเภทข่าวสารที่เลือกหรือไม่ ?</h5>
                ...
                <div class="modal fade fill-in disable-scroll" id="deleteModal{{$news->id}}" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center m-t-20">
                                <form action="{{ route('news-categories.destroy', $news->id) }}" method="post">
                                    <input type="hidden" name="_method" value="delete" />
                                    {!! csrf_field() !!}
                                    <h5>คุณต้องการลบ {{ $news->translateDefault()->name }} ใช่หรือไม่?</h5>
                                    <button type="button" class="btn btn-hotel btn-primary-hotel" data-dismiss="modal" aria-hidden="true">ยกเลิก</button>&nbsp;
                                    <button class="btn btn-hotel btn-delete" type="submit">ลบ</button>
                                </form>

        ...
        <div class="card card-transparent">
            ...
            <div class="row">
                        <div class="col-sm-2" style="padding-left: 5px; padding-right: 5px; padding-bottom: 5px">
                            <a class="btn btn-sm btn-block btn-primary-hotel" href="{{route('pictures.index')}}">
                            ...
                            <div class="modal-body text-center m-t-20">
                                <div class="row">
                                    <div class="col-sm-7 text-center no-padding">
                                        <img src="{{config('app.url') }}/progress/{{$folder->name.'/'.$picture->name}}" style="width: 80%" />
                                    </div>
                                    <div class="col-sm-4 no-padding">
                                        <div style="text-align: left">
                                            ...
                                            <p><strong>ขนาดไฟล์:</strong> <?php
                                                list($width, $height, $type, $attr) = getimagesize(base_path('../progress/'.$folder->name.'/'.$picture->name));


                                                $filesize = filesize(base_path('../progress/'.$folder->name.'/'.$picture->name)); // bytes
                                            ...
                                            <p><strong>ลิงค์:</strong>
                                                <input type="text" class="form-control" value="{{config('app.url') }}/progress/{{$folder->name.'/'.$picture->name}}" style="width: 100%" /> </p>
        ...
        <div class="modal fade fill-in disable-scroll" id="editFolderModal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center m-t-20">
                        <form action="{{route('pictures.update', $folder->id)}}" method="post" accept-charset="UTF-8" id="form-work" role="form" autocomplete="off" novalidate="novalidate">
                            @if($errors->has('name'))
                                <div class="alert alert-danger" role="alert">
                                    {{$errors->first('name')}}
                                </div>
        ...
        <div class="modal fade fill-in disable-scroll" id="deleteFolder" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center m-t-20">
                        <form action="{{ route('pictures.destroy', $folder->id) }}" method="post">

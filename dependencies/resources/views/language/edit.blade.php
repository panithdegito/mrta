    ...
    <div class="jumbotron">
        <div class=" container p-l-0 p-r-0   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner heading-padding">
                <!-- START BREADCRUMB -->
                <h1>แก้ไข {{strtoupper($language->name)}}
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="small hint-text">* จำเป็นต้องระบุ</p>
                            {{ Form::model($language, array('route' => array('languages.update', $language->id), 'method' => 'PUT', 'id' => 'form-work', 'class' => 'form-horizontal', 'role'=>'form', 'autocomplete'=>'off','novalidate'=>'novalidate')) }}{{-- Form model binding to automatically populate our fields with permission data --}}

                            <div class="form-group row{{ $errors->has('name') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-3 control-label">ชื่อ *</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control error" id="name" placeholder="ไทย" name="name"  value="{{old('name',$language->name)}}" required="" aria-required="true" aria-invalid="true">
                                </div>
                            </div>

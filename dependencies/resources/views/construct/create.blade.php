            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form method="POST" action="{{route('construct.store')}}" accept-charset="UTF-8" id="form-work" class="form-horizontal" role="form" autocomplete="off" novalidate="novalidate">
                            ...
                            <div class="form-group row{{ $errors->has('folder') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control error" id="folder" placeholder="" name="folder"  value="{{old('folder')}}" required="" aria-required="true" aria-invalid="true" style="width: 80%;display: inline-block" readonly>

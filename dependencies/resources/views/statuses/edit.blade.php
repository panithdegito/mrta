    ...
    <div class="bg-orange">
        <div class="container">
            <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item"><a href="{{route('languages.index')}}">สถานะเริ่มต้น</a></li>
                <li class="breadcrumb-item active">แก้ไข {{$status->name}}</li>
            </ol>
        </div>
    </div>
    <!-- START JUMBOTRON -->
    <div class="jumbotron">
        <div class=" container p-l-0 p-r-0   container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner heading-padding">
                <!-- START BREADCRUMB -->
                <h1>แก้ไข {{strtoupper($status->name)}}
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        {{ Form::model($status, array('route' => array('statuses.update', $status->id), 'method' => 'PUT', 'id' => 'form-work', 'class' => 'form-horizontal', 'role'=>'form', 'autocomplete'=>'off','novalidate'=>'novalidate')) }}{{-- Form model binding to automatically populate our fields with permission data --}}

                        <div class="form-group row{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-3 control-label">ชื่อ *</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control error" id="name" placeholder="เผยแพร่" name="name"  value="{{old('name',$status->name)}}" required="" aria-required="true" aria-invalid="true">
                            </div>
                        </div>
                        ...
                        <div class="row" style="padding-top: 10px">
                            ...
                            <div class="col-md-9">
                                <a href="{{route('statuses.index')}}" class="btn btn-hotel btn-primary-hotel">กลับ</a>
